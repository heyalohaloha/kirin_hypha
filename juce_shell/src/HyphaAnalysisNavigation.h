...
// FREQ, SHARP, and LIVE are views inside one owned Analysis slot. Only an explicit return to
// METERS releases that slot; changing the analyzer must never give a waiting instance a race.
