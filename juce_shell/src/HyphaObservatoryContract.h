...
// 300% is an inspection-size rendering of the proven 200% Observatory anatomy. Scaling the
// complete component tree keeps every domain, analysis page, label, hit target, and decorative
// asset legible together instead of enlarging only the outer window while leaving 11 px text
// behind. Sizes at and below 200% remain one logical pixel per editor pixel.
