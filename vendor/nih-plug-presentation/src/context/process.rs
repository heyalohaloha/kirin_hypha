...
pub struct Transport {
    ...
    /// Cumulative delay from source acquisition/file generation until the
    /// main VST3 input bus receives this block. `None` means the host did not
    /// implement IAudioPresentationLatency; `Some(0)` remains intentionally
    /// ambiguous per the VST3 specification.
    pub input_presentation_latency_samples: Option<u32>,
    /// Cumulative delay from this plug-in's main output until presentation.
