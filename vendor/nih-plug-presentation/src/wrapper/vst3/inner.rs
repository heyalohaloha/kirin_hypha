...
pub(crate) struct WrapperInner<P: Vst3Plugin> {
    ...
    /// Host-owned presentation latency for the main buses. u32::MAX means the
    /// optional callback has not been received.
    pub input_presentation_latency: AtomicU32,
    pub output_presentation_latency: AtomicU32,
...
impl<P: Vst3Plugin> WrapperInner<P> {
    ...
    pub fn new() -> Arc<Self> {
        ...
        let wrapper = Arc::new(Self {
            ...
            input_presentation_latency: AtomicU32::new(u32::MAX),
            output_presentation_latency: AtomicU32::new(u32::MAX),
