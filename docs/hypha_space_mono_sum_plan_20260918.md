...
実測: MONO は 1 観測あたり **48.2 us**、実時間の **0.048%**。既存 `StereoMeter` の 207.9 us に対して
23% 増だが、絶対値が 100 ms のうち 0.05 ms であり、SPACE を開いたときだけにする理由がない。
